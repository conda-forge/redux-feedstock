...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/redux-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3507&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/redux-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `redux` can be installed with:

```
conda install redux
```

It is possible to list all of the versions of `redux` available on your platform with:
